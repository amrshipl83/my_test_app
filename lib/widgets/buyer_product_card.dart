...
// ... (initState و _onQuantityChanged و _addToCart تبقى كما هي)
  @override
  void initState() {
    super.initState();
...
// لم يتم تعديل هذه الدالة لأن مشاكل الـ Overflow كانت في الـ build الرئيسية ولم تكن في الـ Modal.
