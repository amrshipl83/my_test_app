...
class ProductListGrid extends StatelessWidget {
  ...
  // 🟢🟢 [تعديل جديد]: إضافة دالة رد النداء للتوجيه 🟢🟢
  ...
  const ProductListGrid({
    ...
    this.manufacturerId,
    // 🟢🟢 [تعديل جديد]: استقبال دالة التوجيه 🟢🟢
    this.onProductTap,
  });
      ...
      builder: (context, snapshot) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // 💡 ملاحظة: offerId سيتم استخلاصه من الـ Provider داخل BuyerProductCard
            ...
            return ChangeNotifierProvider<ProductOffersProvider>(
              ...
              child: BuyerProductCard(
                ...
                // 🟢🟢 [الربط]: تمرير دالة التوجيه إلى البطاقة 🟢🟢
                onTap: (selectedProductId, selectedOfferId) {
                  // تنفيذ الدالة المستلمة من الشاشة الأم
