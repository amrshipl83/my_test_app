...
import 'package:my_test_app/screens/invoice_screen.dart'; // ⭐️ 1. تم إضافة استيراد شاشة الفاتورة ⭐️                                                           
...
class _OrdersScreenState extends State<OrdersScreen> {                                                      
  ...
  Future<void> _fetchOrders() async {                    
    ...
    try {                                                  
      ...
      // إبقاء الأخطاء للمستقبل ليتم عرضها في الواجهة      
          ...
          content: SingleChildScrollView(                        
            child: Column(                                         
              ...
              children: [                                            
                ...
                )), // تم حذف .toList() بعد إزالة القوس مباشرة
              ],                                                 
            ),                                                 
          ),                                                   
          actions: [                                             
