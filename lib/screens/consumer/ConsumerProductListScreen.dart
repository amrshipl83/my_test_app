...
class _ConsumerProductListScreenState extends State<ConsumerProductListScreen> {
  ...
  void _addToCart(                                         
    BuildContext context, ProductModel product, ProductOfferModel offer) {                                  
    ...
    cartProvider.addItemToCart(                            
      ...
      name: product.name,                                
      offerId: offer.id!,            // 🟢 إضافة ! لحل مشكلة String?
      sellerId: offer.sellerId!,     // 🟢 إضافة ! للـ SellerId
      sellerName: offer.sellerName!,  // 🟢 إضافة ! للـ SellerName
      unitIndex: 0,                       
      unit: firstUnit.unitName,
      price: firstUnit.price,
      quantityToAdd: 1, // 🟢 إضافة الوسيط الجديد quantityToAdd
    ...
    ScaffoldMessenger.of(context).showSnackBar(            
      const SnackBar(                                        
        content: Text('تم إضافة المنتج إلى السلة بنجاح.', textDirection: TextDirection.rtl),                      
            ...
            ClipRRect(                                             
              ...
              child: Image.network(                                  
                ...
                errorBuilder: (context, error, stackTrace) =>
                    const SizedBox(height: 120, child: Center(child: Icon(Icons.broken_image, size: 40, color: Colors.grey))),                                               
              ),                                                 
            ),                                                   
            // المعلومات
            Padding(                                               
